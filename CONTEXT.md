...
The manifest-bound set of static CupidC, CupidASM, CupidDis, CupidLD, and CupidObj executables under `bootstrap/seeds/i386-linux/`. Verification binds their hashes, sizes, ELF properties, target ABI, producer lineage, source revision, and exact 19-source build plan before execution. The current seed is the stage-three output of a checked-seed bootstrap at revision `8d5ef4564f753d528630c0f0a78db0f535d56b60`. Its CupidC image is 2,511,176 bytes with SHA-256 `4b24bf45726e4ab43fe7830f992120f11de34236daef9ef8753303ab4513934c`. It carries the complete audited Doom compiler frontier, the current GNU assembly and entity metadata, and the active source-driven x87, SSE, descriptor, naked-entry, libm file-scope, kernel-entry BSS-clear, packed SSE2, and double-to-unsigned-wide capabilities. CupidASM and CupidDis carry the 587-row shared x86 catalogue. With all normal host code-generator commands poisoned, all five seed images match stage two; all 19 stage-two C objects, startup, and five images then match stage three. Both stages pass all 21 tool behavior cases over the 40-input snapshot `c5807ad5189552501ed25d2a2a2e37dff94867ab65efaca2fb3cf2db54960c6a`. The recorded seed revision remains separate from a later live source snapshot.
