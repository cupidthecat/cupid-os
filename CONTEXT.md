...
The manifest-bound set of static CupidC, CupidASM, CupidDis, CupidLD, and CupidObj executables under `bootstrap/seeds/i386-linux/`. Verification binds their hashes, sizes, ELF properties, target ABI, producer lineage, source revision, and exact 19-source build plan before execution. The current seed comes from revision `6f880cc3cf5cced72b81e0d66079aaca913d0a03`. Its 2,574,032-byte CupidC image has SHA-256 `8d810739494123a3da1cba34f75f58c005e8796f2cb4e85ba57eead1578a1f4d`. CupidASM remains 445,616 bytes, CupidDis 379,648 bytes, and CupidLD 266,672 bytes. CupidObj is 270,700 bytes with SHA-256 `a8de7de19d1ffbec90f0603f0f796f4a03fa74b8181c62f0f395b22a52423d1d`. The 5,440-byte manifest has SHA-256 `729cd702e34695cf9ee619d10446ce80838ed9a25a14efa856833b2bf37629f3`. The seed retains the complete 83-root Doom frontier and the later kernel, GNU assembly, x87, SSE, and ABI capabilities. It carries the returns-twice call boundary, runtime floating truth, the 592-row shared x86 catalogue with forward stack subtraction, typed CupidDis raw code and data ranges, and both CupidObj source-generation contracts. The kernel-symbol operation accepts canonical CupidDis text and emits the exact packed `.cc` source transactionally. The latest transition froze 41 source inputs with SHA-256 `26555c8a95721689f502fea47c52da8911d10307af3142d82b4da0a53d0bfba0`. Only the preceding CupidObj image differed from stage two. The post-promotion reproof matches all five seed images to stage two, then matches all 19 C objects, startup, and five tools between stages two and three. Both stages pass five help cases, eleven successful operations, and seven useful failures. ADR 0223 records this promotion.
