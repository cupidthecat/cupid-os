...
The manifest-bound set of static CupidC, CupidASM, CupidDis, CupidLD, and CupidObj executables under `bootstrap/seeds/i386-linux/`. Verification binds their hashes, sizes, ELF properties, target ABI, producer lineage, source revision, and exact 19-source build plan before execution. The current seed is the stage-three output of a checked-seed bootstrap at revision `d76f543948621ea04520d019fad9aae670f17f11`. Its CupidC image is 1,946,320 bytes with SHA-256 `57bea3f86ad601254539d96081473a8309400eedfef46c03e2ad34d0f195351c`. With host compiler and linker commands poisoned, all five seed images match stage two; all 19 stage-two C objects, startup, and five images then match stage three. Both stages pass all 21 tool behavior cases over the 40-input snapshot `cf17ed01addfb3ce6743785b14d523b86b2eedf34579df10aa4682cb1642ab35`. The recorded seed revision remains separate from a later live source snapshot.
