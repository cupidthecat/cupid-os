...
The manifest-bound set of static CupidC, CupidASM, CupidDis, CupidLD, and CupidObj executables under `bootstrap/seeds/i386-linux/`. Verification binds their hashes, sizes, ELF properties, target ABI, producer lineage, source revision, and exact 19-source build plan before execution. The current seed is the stage-three output of a checked-seed bootstrap at revision `10d2412ece22968e03dbe22b048c3d92f210f2ba`. Its CupidC image is 1,950,556 bytes with SHA-256 `f4d49d8b870868ccd57aed94eaf7565404ceb10732c79c868e65f9beca5371c8`. With host compiler and linker commands poisoned, all five seed images match stage two; all 19 stage-two C objects, startup, and five images then match stage three. Both stages pass all 21 tool behavior cases over the 40-input snapshot `e0e5bb3d520c8c1e9354ae359c3e41f891702cd07e57235cd98ae661f8b8bd85`. The recorded seed revision remains separate from a later live source snapshot.
