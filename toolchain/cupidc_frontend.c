...
static ctool_status_t cfront_append_zero_initializer(
  ...
  cfront_initializer_init(&initializer, CTOOL_C_INITIALIZER_ZERO,
                          object_type, token);
  return cfront_append_initializer(context, &initializer, initializer_out);
}
