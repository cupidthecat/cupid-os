...
There are no security boundaries or privilege levels—all code runs in ring 0. This can be changed depending on how cupid-os ends up. There are no Minmala privilege levels at the most.
