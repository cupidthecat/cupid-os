...
CupidASM and CupidDis also share the complete i386 SHRD family. The ISO
...
Source head now parses all 29 declarations in `simd_intrin.h` under its proper
...
The five static i386 Linux tools have a checked bootstrap seed. Its manifest binds the exact binaries, source revision, target ABI, producer lineage, 19-source build plan, and five link orders before execution. The current cohort comes from revision `6f880cc3cf5cced72b81e0d66079aaca913d0a03`. CupidC remains a 2,574,032-byte image with SHA-256 `8d810739494123a3da1cba34f75f58c005e8796f2cb4e85ba57eead1578a1f4d`; it carries the returns-twice boundary, complete 83-root Doom frontier, runtime floating truth, and the earlier kernel and ABI capabilities. CupidASM and CupidDis in that seed retain the 592-row shared x86 catalogue with canonical `FSUB ST(1), ST(0)`. Source head has 596 rows and adds canonical SHRD without changing the checked trust root yet. CupidDis retains typed raw code and data ranges. CupidObj is 270,700 bytes with SHA-256 `a8de7de19d1ffbec90f0603f0f796f4a03fa74b8181c62f0f395b22a52423d1d`. Alongside its installation-source and linked-symbol contracts, it can generate the packed kernel-symbol `.cc` source from canonical CupidDis text. The 5,440-byte manifest has SHA-256 `729cd702e34695cf9ee619d10446ce80838ed9a25a14efa856833b2bf37629f3`. [ADR 0223](docs/adr/0223-promote-cupidobj-kernel-symbol-source.md) records the current promotion.
