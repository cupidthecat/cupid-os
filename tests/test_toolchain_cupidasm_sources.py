...
OBJECT_FIXTURES = (
    {
        ...
        "text_size": 377,
        "text_sha256": "09434aeb25549b239065814f2fbbfbbe80c079cb56fe522ab1f79b18d3f93417",
        "symbol_count": 38,
        "binding_counts": {0: 2, 1: 36},
        "placement_counts": {".text": 33, "UND": 5},
        "relocations": (
            (".text", 0x15, 2, -4, "isr_handler"),
            (".text", 0x3C, 2, -4, "irq_handler"),
            (".text", 0x148, 2, -4, "fpu_nm_handler"),
            (".text", 0x158, 2, -4, "fpu_mf_handler"),
            (".text", 0x168, 2, -4, "fpu_xf_handler"),
        ),
    },
    {
        "name": "context-switch",
        ...
        "text_size": 44,
        "text_sha256": "6c926a52a59c328e65d3ca1dea1d4eb9355ea8b08478f27b5ea521d93ba980cb",
        "symbol_count": 2,
        "binding_counts": {1: 2},
        "placement_counts": {".text": 2},
        "relocations": (),
    },
)
