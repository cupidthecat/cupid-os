...
class ToolchainCupidCFrontendContractTests(unittest.TestCase):
    ...
    def test_active_switch_label_inventory_is_drift_gated(self):
        ...
        self.assertEqual(features["c.control.switch"]["occurrences"], 237)
        self.assertEqual(len(features["c.control.switch"]["files"]), 73)
        self.assertEqual(features["c.control.case"]["occurrences"], 1790)
        self.assertEqual(len(features["c.control.case"]["files"]), 73)
        self.assertEqual(features["c.control.default"]["occurrences"], 167)
        self.assertEqual(len(features["c.control.default"]["files"]), 60)
