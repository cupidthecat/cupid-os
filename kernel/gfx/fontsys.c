...
/* Bundled font symbols. CupidObj wraps the four regular faces selected by the
 * Makefile. Italic and bold styling are synthesized at draw time rather than
 * requiring additional bundled font files.*/
