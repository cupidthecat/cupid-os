/**
 * font_8x8.cc - 8x8 bitmap font for Cupid OS graphical mode
 *
 * Each character is 8 bytes; each byte represents one row of 8 pixels.
 * The MSB is the leftmost pixel.  Covers ASCII 0-127.
*/
...
const uint8_t font_8x8[128][8] = {
    ...
    /* 0x05  ENQ */ { 0x38, 0x7C, 0x38, 0xFE, 0xFE, 0x54, 0x10, 0x7C },
    /* 0x06  ACK */ { 0x10, 0x38, 0x7C, 0xFE, 0xFE, 0x7C, 0x10, 0x7C },
    ...
    /* 0x10  DLE */ { 0x80, 0xE0, 0xF8, 0xFE, 0xF8, 0xE0, 0x80, 0x00 },
    /* 0x11  DC1 */ { 0x02, 0x0E, 0x3E, 0xFE, 0x3E, 0x0E, 0x02, 0x00 },
    /* 0x12  DC2 */ { 0x18, 0x3C, 0x7E, 0x18, 0x18, 0x7E, 0x3C, 0x18 },
    /* 0x13  DC3 */ { 0x66, 0x66, 0x66, 0x66, 0x66, 0x00, 0x66, 0x00 },
    /* 0x14  DC4 */ { 0x7F, 0xDB, 0xDB, 0x7B, 0x1B, 0x1B, 0x1B, 0x00 },
    /* 0x15  NAK */ { 0x3E, 0x63, 0x38, 0x6C, 0x6C, 0x38, 0xCC, 0x78 },
    /* 0x16  SYN */ { 0x00, 0x00, 0x00, 0x00, 0x7E, 0x7E, 0x7E, 0x00 },
    /* 0x17  ETB */ { 0x18, 0x3C, 0x7E, 0x18, 0x7E, 0x3C, 0x18, 0xFF },
    /* 0x18  CAN */ { 0x18, 0x3C, 0x7E, 0x18, 0x18, 0x18, 0x18, 0x00 },
    /* 0x19  EM */ { 0x18, 0x18, 0x18, 0x18, 0x7E, 0x3C, 0x18, 0x00 },
    /* 0x1A  SUB */ { 0x00, 0x18, 0x0C, 0xFE, 0x0C, 0x18, 0x00, 0x00 },
    /* 0x1B  ESC */ { 0x00, 0x30, 0x60, 0xFE, 0x60, 0x30, 0x00, 0x00 },
    /* 0x1C  FS */ { 0x00, 0x00, 0xC0, 0xC0, 0xC0, 0xFE, 0x00, 0x00 },
    /* 0x1D  GS */ { 0x00, 0x24, 0x66, 0xFF, 0x66, 0x24, 0x00, 0x00 },
    /* 0x1E  RS */ { 0x00, 0x18, 0x3C, 0x7E, 0xFF, 0xFF, 0x00, 0x00 },
    /* 0x1F  US */ { 0x00, 0xFF, 0xFF, 0x7E, 0x3C, 0x18, 0x00, 0x00 },
