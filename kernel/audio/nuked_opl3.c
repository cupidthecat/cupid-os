 ...
 * Commit: cfedb09efc03f1d7b5fc1f04dd449d77d8c49d50 (HEAD as of 2026-05-06)
 * License: LGPL-2.1
 *
 * Local modifications:
 *  - Replaced <stdio.h>, <stdlib.h>, <string.h>, <math.h> includes with
 *    kernel headers so the file compiles under the kernel's -nostdlib -nostdinc.
 *  - <stdio.h> and <stdlib.h> removed (no printf/malloc usage in this file).
 *  - <string.h> replaced with "../string.h" (provides memset/memcpy).
 *  - <math.h> conditional block kept but guarded by OPL_ENABLE_STEREOEXT=0
 *    (default); the #include <math.h> line is commented out since it is
...
/* UINT64_C is from <stdint.h>; provide equivalent suffix macro. */
#ifndef UINT64_C
