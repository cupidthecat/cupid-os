 ...
 *    - Stack grows downward through [0x00D00000, 0x00F00000)
...
void _start(void) {
    ...
    __asm__ volatile(
         ...
         * fixed [0x00D00000, 0x00F00000) stack reservation. See memory.h.*/
        "mov $0xF00000, %%esp\n"
        "mov %%esp, %%ebp\n"
...
*/
    ...
    if (fontsys_load_os_default_from_conf() == 0) {
        ...
        KINFO("fontsys: no /etc/font.conf, bitmap default");
    }
    gui_themes_init();
    gui_widgets_init();
    gui_containers_init();
