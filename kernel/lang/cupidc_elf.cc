/**
 * cupidc_elf.cc - ELF32 binary writer for the CupidC compiler
 *
 * Writes compiled CupidC code as a standard ELF32 executable that
 * can be loaded by the existing Cupid OS ELF loader.
 *
 * The output ELF has:
 *   - ELF header (52 bytes)
...
/* Fixed CupidC AOT arena accepted by kernel/lang/exec.cc. */
