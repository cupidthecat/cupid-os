/* ChaCha20-based CSPRNG for Cupid OS.
 *
 * The state replaces the LCG formerly kept in kernel/fs/devfs.cc. It consists
 * of a 32-byte key and a 12-byte nonce. Each call advances the key with
 * DJB-style fast key erasure: a fresh 64-byte ChaCha20 block is produced; the
