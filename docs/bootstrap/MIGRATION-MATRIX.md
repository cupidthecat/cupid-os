...
source graph retains 745 active language inputs, including 299 headers. The
C-family inventory covers 709 files and 2,487 include operands, including
2,211 quoted operands. These source-current counts supersede the 65-input,
