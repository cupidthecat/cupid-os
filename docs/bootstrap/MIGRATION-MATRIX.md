...
Source head has 592 x86 forms, 244 canonical mnemonics, 64 registers, and
fingerprint `F4420CB4`. The added row encodes canonical
`FSUB ST(1), ST(0)` as `DC E9`. The checked seed remains on 591 forms and
fingerprint `DBE77533` until promotion. This supersedes older counts below.
