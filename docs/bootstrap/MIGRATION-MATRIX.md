...
5/17/15 matrix. ADR 0247 records the format boundary, ADR 0248 records imports
and loader execution, and ADR 0258 records checked-seed carriage.
...
The checked seed and source head have 602 x86 forms, 247 canonical mnemonics,
64 registers, and fingerprint `64429699`. Six rows cover signed x87 `FILD` and
...
0252 records the x87 integer forms, and ADR 0258 records their checked-seed
carriage. ADR 0253 records their first CupidC runtime use.
