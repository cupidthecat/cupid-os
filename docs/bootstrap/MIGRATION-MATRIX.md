...
Source-head CupidObj now performs the same checks through transactional
`wrap-jpeg` before applying the ordinary binary wrapper. The checked seed and
production recipe predate the command. ADR 0231 records the capability and
