...
Source head now has 591 x86 forms, 244 canonical mnemonics, 64 registers, and
fingerprint `DBE77533`. This supersedes the 590-form source-head counts in
older rows below; `FLDZ` is the fourth form added after the checked seed.
