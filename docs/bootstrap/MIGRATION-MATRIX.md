...
9,580,120-byte `kernel/kernel.elf.pass1` with SHA-256
...
ratios beyond the bounded parser, other floating-to-wide conversions, atomic
floating compound assignment, and atomic or long-double increment and
decrement remain open. ADR 0250 records
runtime unsigned
four-byte output,
