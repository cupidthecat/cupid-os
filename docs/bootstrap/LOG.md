...
- Pass-one ELF/raw SHA-256 values are `0ce2ba7d59814f57bae630f1cb5eb4ee70ddb7fe54f266fcbc83a5b9f8dd74a3` and `1a1e5267508d615aeb8dd4ec16f8d2ace39bbdf32a885dbdc6e02e054c640d71`. Final ELF/raw values are `b2468ff33bcfe6120f736ba604e16cdc3fc75a6a655cb58333b9248b1cd7ee4f` and `befb13979b9ec3eb5265568cd07d292a89278324bf32ab224f64e7709be0d4da`. CupidLD, LLD, and the production pass generate byte-identical ksyms C, SHA-256 `c16fd2b8fc2da3ad13c676349dc7b9014ffa9a8d0fd7ccb3d4ff13013c3f81ee`.
...
| `python -m unittest discover -s tests -p "test_*.py"` | PASS | 117 tests passed in 52.909 seconds; the Windows-only `/dev/full` case was skipped and remains covered under Linux. |
| Kernel loader/process contracts | PASS | 36 positive/negative and production-boundary cases passed under Windows Clang and WSL GCC. They cover malformed rollback, all three arenas, lease generations, create failure, immediate/remote kill, local/remote CPU quiescence, BKL handoff and nested deferral, real IPI request ordering/consumption, stack-canary cleanup, and permanent-page non-release. |
...
| CupidC/CupidASM AOT | PASS | `ccc` wrote `/home/cctest` at `0x01000000` and `cupidasm` wrote `/home/asmtest` at `0x01A00000`; separate boots loaded, ran, exited, and reaped both without panic. |
