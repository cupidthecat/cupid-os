...
carriage, ADR 0252 records the x87 integer forms, and ADR 0258 records their
checked-seed carriage. These counts supersede older source-head references
below.
