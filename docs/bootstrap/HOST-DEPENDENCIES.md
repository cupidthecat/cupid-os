...
The two object sets are byte-identical; each totals 3,717,856 bytes. The combined 155-root graph
...
`long double` comparisons, integer conversions involving `long double`,
