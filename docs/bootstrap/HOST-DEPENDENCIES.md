...
The checked seed and source head share 591 x86 forms, 244 canonical mnemonics,
64 registers, and fingerprint `DBE77533`. ADR 0203 carries `FLDZ` and the other
