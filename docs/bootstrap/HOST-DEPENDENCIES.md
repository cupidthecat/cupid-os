...
call Python. The checked seed now carries the command, so a separate ownership
change can move the three recipes to CupidObj. ADRs 0201 and 0203 record the
capability and seed boundaries.
