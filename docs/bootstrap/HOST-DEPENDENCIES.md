...
Source head's shared x86 catalogue now has 591 forms, 244 canonical
mnemonics, 64 registers, and fingerprint `DBE77533`. `FLDZ` is the fourth form
added after the checked seed. This count supersedes older 590-form
