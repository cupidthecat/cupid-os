...
The checked seed and source head carry 596 rows, 245 canonical mnemonics, and
fingerprint `DA15E97F`. The four SHRD rows cover immediate or CL counts at
both operand widths. The forward x87 row is canonical
