...
The normal root build gives checked-seed CupidC ownership of 154 checked-in
sources and the generated kernel symbol source. All 155 sources use `.cc`.
...
transfer, ADR 0176 records the libm transfer, and ADR 0180 records the kernel
entry and SIMD transfer.
...
validator. The production frontier covers 154 approved sources, and every
...
all 154 roots twice against a 443-file snapshot with SHA-256
`c94e8f69bfb3de5792ad81ec0334b4ef88be56d6437926f32146630c26f0b50d`.
Both object passes are byte-identical; each totals 3,694,528 bytes. The combined
...
The 154-root graph passes the two-link symbol and memory checks plus clean
