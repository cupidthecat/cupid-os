...
| `kernel_util` | 2 | 660 |
| `project_source` | 1 | 5 |
| `toolchain_contract` | 25 | 171022 |
| `toolchain_core` | 48 | 99099 |
...
| `c_preprocessor_conditionals` | `pass` | 227 conditional expressions (216 #if, 11 #elif); 41 normalized expressions; 43 directive/expression pairs |
