...
- Unreachable source-like files: 26
...
| --- | ---: | ---: |
| `asm.addressing` | 6 | 363 |
| `asm.delivery` | 1 | 22 |
| `asm.directive` | 19 | 389 |
| `asm.expression` | 2 | 13 |
| `asm.instruction` | 91 | 1543 |
| `asm.label` | 2 | 194 |
| `asm.output` | 2 | 5 |
| `asm.prefix` | 2 | 6 |
...
| `c_preprocessor_conditionals` | `pass` | 174 conditional expressions (165 #if, 9 #elif); 35 normalized expressions; 37 directive/expression pairs |
| `c_preprocessor_cupid_exe` | `pass` | 1 Cupid #exe blocks (1 #, 0 %:); max conditional depth 0 |
| `c_preprocessor_include_operands` | `pass` | 2497 C include operands (2219 quoted, 278 angle, 0 pp-token); 711 source files; max conditional depth 2 |
...
| `cupid_toolchain_fixed_point` | `pass` | 22 tool C sources (21 strict, 1 GNU); 6 tools (cupidasm=8, cupiddis=8, cupidld=7, cupidobj=7, cupidc=12, cupidbuild=8); 22 C objects and 1 startup object compared across stages; 6 tool images; 29 success and 23 failure cases; i386-linux |
