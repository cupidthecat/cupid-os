...
| `kernel_usb` | 8 | 3518 |
| `kernel_util` | 2 | 660 |
| `toolchain_contract` | 15 | 134151 |
| `toolchain_core` | 31 | 73962 |
...
| 12 | `cupid_mode_production_and_extensions` - Scale Cupid mode across embedded programs and browser fragments | 288 |
