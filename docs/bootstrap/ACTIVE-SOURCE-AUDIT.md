...
| `c_preprocessor_conditionals` | `pass` | 168 conditional expressions (159 #if, 9 #elif); 35 normalized expressions; 37 directive/expression pairs |
