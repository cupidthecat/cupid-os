...
| `c_preprocessor_include_operands` | `pass` | 2502 C include operands (2219 quoted, 283 angle, 0 pp-token); 711 source files; max conditional depth 2 |
