...
| `kernel_util` | 2 | 660 |
| `project_source` | 1 | 5 |
| `toolchain_contract` | 25 | 168532 |
| `toolchain_core` | 45 | 92344 |
...
| --- | ---: | ---: |
| `asm.addressing` | 6 | 347 |
| `asm.delivery` | 1 | 22 |
| `asm.directive` | 19 | 383 |
| `asm.expression` | 2 | 13 |
| `asm.instruction` | 91 | 1520 |
| `asm.label` | 2 | 191 |
| `asm.output` | 2 | 5 |
| `asm.prefix` | 2 | 6 |
...
| ---: | --- | ---: |
| 1 | `host_runnable_toolchain_core` - Establish a host-runnable shared Cupid Toolchain core | 94 |
...
| 8 | `cupidc_preprocessor` - Implement the active C and Cupid C preprocessing contract | 567 |
| 9 | `cupidc_c11_types_initializers_and_abi` - Implement freestanding C11 type, initializer, and cdecl semantics | 673 |
...
| ---: | --- | ---: | --- |
| 1 | `toolchain_sources` | 94 | Bootstrap the tools that transfer ownership to every later cohort. |
...
| `c_preprocessor_include_operands` | `pass` | 2489 C include operands (2212 quoted, 277 angle, 0 pp-token); 709 source files; max conditional depth 2 |
| `c_preprocessor_line_directives` | `pass` | 0 named #line directives (0 direct, 0 pp-token; 0 filename); 0 numeric markers; 709 source files; max conditional depth 0 |
