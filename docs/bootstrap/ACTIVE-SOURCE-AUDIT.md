...
| ---: | --- | ---: |
| 1 | `host_runnable_toolchain_core` - Establish a host-runnable shared Cupid Toolchain core | 76 |
...
| 8 | `cupidc_preprocessor` - Implement the active C and Cupid C preprocessing contract | 551 |
| 9 | `cupidc_c11_types_initializers_and_abi` - Implement freestanding C11 type, initializer, and cdecl semantics | 655 |
...
| ---: | --- | ---: | --- |
| 1 | `toolchain_sources` | 76 | Bootstrap the tools that transfer ownership to every later cohort. |
