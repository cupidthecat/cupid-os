...
| `kernel_usb` | 8 | 1701 |
| `kernel_util` | 2 | 660 |
| `toolchain_contract` | 10 | 14663 |
| `toolchain_core` | 14 | 17382 |
...
| `c_preprocessor_include_operands` | `pass` | 2296 C include operands (2100 quoted, 196 angle, 0 pp-token); 645 source files; max conditional depth 2 |
