...
ADR 0021 closes the direct ordinary member-address frontier named above. Issue #25 remains open. General statements, bit-field extraction, subscript and pointer-based addresses, compound and update lowering, atomic ordering, other value widths, floating and aggregate values, indirect and variadic calls, call-site alignment, production integration, and staged self-hosting still remain.
