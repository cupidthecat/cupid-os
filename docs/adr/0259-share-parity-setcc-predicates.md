...
At this decision boundary, the checked five-tool seed still predated the two
rows. ADR 0265 later promoted them with the indexed decoder from ADR 0266. A
...
Issue #13 remains open for the broader self-hosting work, and issue #31 remains
open for the rest of the private CupidC runtime. No `.c` to `.cc` rename is
