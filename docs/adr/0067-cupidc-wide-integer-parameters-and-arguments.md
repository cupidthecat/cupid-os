...
ADRs 0069 and 0070 later add wide comparisons, scalar conditions, addition, subtraction, unary plus, unary minus, and bitwise complement. ADR 0071 adds signed and unsigned wide switch dispatch, and ADR 0072 adds multiplication. Wide division, remainder, mutation, values without declared parameter types, floating values, production integration, staged self-hosting, and the fixed-point bootstrap remain unfinished.
