...
Issue #25 remains open. ADR 0069 later adds wide comparisons and scalar conditions, ADR 0070 adds wide addition, subtraction, and nonlogical unary operations, ADR 0071 adds full-width switch dispatch, and ADR 0072 adds multiplication. Wide division, remainder, compound mutation, increment and decrement, values without declared parameter types, floating values, production integration, staged self-hosting, and the fixed-point bootstrap remain unfinished.
